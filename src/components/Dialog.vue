<template>
  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" v-if="addFlag" @click="addCommodity"
        >确 定</el-button
      >
      <el-button type="primary" v-if="!addFlag" @click="updateCommodity"
        >确 定</el-button
      >
    </span>
  </el-dialog>
