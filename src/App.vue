...
export default {
  ...
  created() {
    ...
    if (sessionStorage.getItem("user")) {
      ...
      this.saveUser(
        Object.assign({}, JSON.parse(sessionStorage.getItem("user")))
      );
    } else if (sessionStorage.getItem("sell")) {
      // console.log(sessionStorage.getItem("sell"));
      this.saveSell(
        Object.assign({}, JSON.parse(sessionStorage.getItem("sell")))
      );
    } else if (sessionStorage.getItem("admin")) {
      this.saveAdmin(
        Object.assign({}, JSON.parse(sessionStorage.getItem("admin")))
      );
    }
  },
  methods: {
